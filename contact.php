...
?>
    ...
    <div class="container" style="background-color: #fff;">
        ...
        <div class="wrapper">
            <div class="row" id="contact" style="box-shadow: none; display:flex; flex-gap:20px;">
            ...
            <form action="" method="post">
                <div class="user-details" style="grid-template-columns: repeat(2, 1fr);">
                    <div class="input-box">
                    ...
                    <div class="input-box" id="alertBox">
                            <p id="msg"></p>
                            <p><span class="closeMsg"><i class="fa-solid fa-xmark"></i></span></p>
                    </div>
